...
# Sign up form class
# Inherit the UserCreationForm from Django
class SignUpForm(UserCreationForm):

    # Set up formfields for email, firstname, and lastname
    ...
    # Allow signup form constructor to accept any positional and keyword arguments
    def __init__(self, *args, **kwargs):
        super(SignUpForm, self).__init__(*args, **kwargs)

        # Customization for CSS purposes
...
# All code copied from the SignUpForm class
class UpdateUserForm(UserChangeForm):

    # Hide the auto Django password message
    password = None
...
# Form to update the User's profile info
